...
func ConsulRegistration(consulAddress string, hostname string, port string) {
	// Create a new Consul API client
	config := api.DefaultConfig()
	config.Address = consulAddress // Use the domain name and port of your Consul server
...
func main() {
	...
	ConsulRegistration(consulAddress, hostname, port)
